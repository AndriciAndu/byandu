	...
	(function(){
		...
		var targetParent = document.getElementById('cssColorNames-main');

		function generateItems(obj) {
			for (var key in obj) {
				if (obj.hasOwnProperty(key)) {

					var colorArray = obj[key];

					var newElem = document.createElement('div');
					newElem.classList = 'col-12 sticky-title';
					newElem.innerHTML = key ;
					targetParent.appendChild(newElem);

					colorArray.map(function(colorObj) { 
						var newElem = document.createElement('div');
						newElem.classList = 'col-12 article-colorItemWrapper';
						newElem.innerHTML = 
							'<div class="article-colorItem" data-colorGroup="'+key+'"> ' +
								'<div class="col-4 md-col-1"><div class="article-colorItem__sample" style="background-color:'+colorObj.hex+'">&nbsp;</div></div> ' +
								'<div class="col-8 md-col-4 border-left"><div class="colorItem-clickTarget article-colorItem__name" data-color="'+colorObj.name+'">'+colorObj.name+'</div></div> ' +
								'<div class="col-4 md-col-3 border-left"><div class="colorItem-clickTarget article-colorItem__hex"  data-color="'+colorObj.hex+'">' +colorObj.hex+ '</div></div> ' +
								'<div class="col-8 md-col-4 border-left"><div class="colorItem-clickTarget article-colorItem__rgb"  data-color="'+colorObj.rgb+'">' +colorObj.rgb+ '</div></div> ' +
							'</div> ' ;
						targetParent.appendChild(newElem);
					})
				}
