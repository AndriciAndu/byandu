	...
	// --------------------------------
		...
		(function(){
			...
			// --------------------------------
				...
				byAndu_finalCode_generateRadioSelects('html', demoItemsArray, 'hasFilter-');
				byAndu_finalCode_generateCheckboxes('css', demoItemsArray, 'hasFilter-');
                byAndu_finalCode_generateRadioSelects('css-singular', demoItemsArray, 'hasFilter-');
