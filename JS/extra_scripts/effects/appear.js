	...
	// --------------------------------
		...
		(function(){
			...
			// --------------------------------
				...
				byAndu_finalCode_generateRadioSelects('html', demoItemsArray);
				byAndu_finalCode_generateCheckboxes('css', cssOptionsArray);
				byAndu_finalCode_generateCheckboxes('js', []);
